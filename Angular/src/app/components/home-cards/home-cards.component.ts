 ...
 products = [
  ...
  scrollCards(direction: string) {
    ...
    if (cardsContainer instanceof HTMLElement) {
      const cardWidth = cardsContainer.querySelector('.card')?.clientWidth;
      const scrollAmount = cardWidth ? cardWidth + 20 : 0; // Adjust the scroll amount based on your card's width and margin
